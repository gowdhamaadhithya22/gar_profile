...
(()=>{
    ...
    var Ye = me(()=>{
        window.tram = function(t) {
            ...
            var h = m.frame = function() {
              ...
              , n = K(function(e) {
                ...
                function D(z) {
                    ...
                    var re;
                    typeof z == "string" ? (re = {},
                    re[z] = 1) : re = typeof z == "object" && z != null ? z : this.props,
                    Ce.call(this, re, we),
                    he.call(this)
                }
                function $(z) {
              ...
              , F = K(function(e) {
                ...
                ,
                e.play = function() {
                    this.active || (this.start || (this.start = A()),
                    this.active = !0,
                    s(this))
                }
                ,
            ...
            _.transform && _.backface && (ie.z = [B, "translateZ"],
            ie.rotateZ = [ae],
            ie.scaleZ = [y],
            ie.perspective = [L]);
            var ye = /ms/
...
` + U + "}",
    ...
    var gt = me((gn,mt)=>{
        ...
        pt.define("brand", mt.exports = function(t) {
            var m = {}, v = document, x = t("html"), V = t("body"), T = ".w-webflow-badge", M = window.location, I = /PhantomJS/i.test(navigator.userAgent), O = "fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange", Z;
            m.ready = function() {
                var S = x.attr("data-wf-status")
                  , q = x.attr("data-wf-domain") || "";
                /\.webflow\.io$/i.test(q) && M.hostname !== q && (S = !0),
                S && !I && (Z = Z || K(),
                j(),
                setTimeout(j, 500),
            ...
            function K() {
                var S = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs")
                  , q = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon.f67cd735e3.svg").attr("alt", "").css({
                    marginRight: "8px",
                    width: "16px"
                })
    ...
    var bt = me((wn,wt)=>{
        ...
        et.define("edit", wt.exports = function(t, m, v) {
            ...
            var x = {}, V = t(window), T = t(document.documentElement), M = document.location, I = "hashchange", O, Z = v.load || j, te = !1;
            try {
            ...
            function S(N) {
                return function(L) {
                    ...
                    q(Y(L.bugReporterScriptPath), function() {
            ...
            function P(N) {
                ...
                var B = function(ae) {
                    ae.data === "WF_third_party_cookies_unsupported" ? (y(L, B),
                    N(!1)) : ae.data === "WF_third_party_cookies_supported" && (y(L, B),
                    N(!0))
                };
                L.onerror = function() {
                    y(L, B),
    ...
    var Lt = me((xn,Ot)=>{
        ...
        qe.define("links", Ot.exports = function(t, m) {
            var v = {}, x = t(window), V, T = qe.env(), M = window.location, I = document.createElement("a"), O = "w--current", Z = /index\.(html|php)$/, te = /\/$/, K, j;
    ...
    var St = me((kn,Ct)=>{
        ...
        sn.define("touch", Ct.exports = function(t) {
            ...
            m.init = function(T) {
                return T = typeof T == "string" ? t(T).get(0) : T,
                T ? new x(T) : null
            }
            ;
            function x(T) {
    ...
    var Ft = me((On,Wt)=>{
        ...
        $e.define("forms", Wt.exports = function(t, m) {
            var v = {}, x = t(document), V, T = window.location, M = window.XDomainRequest && !window.atob, I = ".w-form", O, Z = /e(-)?mail/i, te = /^\S+@\S+$/, K = window.alert, j = $e.env(), S, q, G, Y = /list-manage[1-9]?.com/i, X = m.debounce(function() {
            ...
            function P() {
                ...
                q = "https://webflow.com/api/v1/form/" + O,
                M && q.indexOf("https://webflow.com") >= 0 && (q = q.replace("https://webflow.com", "https://formdata.webflow.com")),
                G = `${q}/signFile`,
                V = t(I + " form"),
                V.length && V.each(y)
            }
            ...
            function pe(h, A, n, o) {
                var a = null;
                return A === "password" ? a = "Passwords cannot be submitted." : h.attr("required") ? o ? Z.test(h.attr("type")) && (te.test(o) || (a = "Please enter a valid email address for: " + n)) : a = "Please fill out the required field: " + n : n === "g-recaptcha-response" && !o && (a = "Please confirm you\u2019re not a robot."),
                a
            }
            function R(h) {
                k(h),
    ...
    var Ht = me((Tn,zt)=>{
        ...
        Me.define("navbar", zt.exports = function(t, m) {
            var v = {}, x = t.tram, V = t(window), T = t(document), M = m.debounce, I, O, Z, te, K = Me.env(), j = '<div class="w-nav-overlay" data-wf-ignore />', S = ".w-nav", q = "w--open", G = "w--nav-dropdown-open", Y = "w--nav-dropdown-toggle-open", X = "w--nav-dropdown-list-open", P = "w--nav-link-open", y = fn.triggers, N = t();
            ...
            function Q(r, g) {
                ...
                function s() {
                    ...
                    r.overlay && r.overlay.children().length && (N.length ? r.menu.insertAfter(N) : r.menu.prependTo(r.parent),
    ...
    var Xt = me((Cn,Bt)=>{
        ...
        Ie.define("slider", Bt.exports = function(t, m) {
            var v = {}, x = t.tram, V = t(document), T, M, I = Ie.env(), O = ".w-slider", Z = '<div class="w-slider-dot" data-wf-ignore />', te = '<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />', K = "w-slider-force-show", j = ln.triggers, S, q = !1;
            v.ready = function() {
                M = Ie.env("design"),
                G()
            }
            ...
            function N(n) {
                ...
                L(n.el.attr("data-hide-arrows")) ? o.hideArrows = !0 : n.config.hideArrows && (n.left.show(),
                n.right.show()),
